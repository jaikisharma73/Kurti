...
export const metadata = {
  title: 'Terms of Service | ZorryFash',
  description: 'Read the terms of service, conditions of website use, license access, and product descriptions for shopping on ZorryFash.',
}
