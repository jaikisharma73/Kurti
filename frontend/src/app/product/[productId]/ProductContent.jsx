      ...
      <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
        ...
        <div className='flex-1'>
          ...
          <div className=' flex items-center gap-1 mt-2'>
            {[1, 2, 3, 4, 5].map((star) => (
              <img key={star} src={star <= Math.round(productData.rating || 0) ? assets.star_icon.src || assets.star_icon : assets.star_dull_icon.src || assets.star_dull_icon} alt="" className="w-3.5" />
            ))}
                  ...
                  productData.reviews.slice().reverse().map((rev, index) => (
                    <div key={index} className='border-b pb-4'>
                      <div className='flex items-center gap-2 mb-1'>
                        ...
                        <div className='flex'>
                          {[1, 2, 3, 4, 5].map((star) => (
                            <img key={star} src={star <= rev.rating ? assets.star_icon.src || assets.star_icon : assets.star_dull_icon.src || assets.star_dull_icon} alt="" className="w-3" />
                          ))}
                        </div>
