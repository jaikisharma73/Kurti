...
export const metadata = {
  title: 'Size Guide & Fit Chart | ZorryFash',
  description: 'Detailed apparel size guide for Small, Medium, Large, and Extra-Large ranges, including measurement directions for chest, waist, and hips.',
}
