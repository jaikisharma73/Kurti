...
export const metadata = {
  title: 'Returns & Exchanges | ZorryFash',
  description: 'Understand ZorryFash return procedures, 7-day product eligibility requirements, refund processes, and options for apparel size exchanges.',
}
