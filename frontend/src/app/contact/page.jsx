...
export const metadata = {
  title: 'Contact Us | ZorryFash Customer Support',
  description: 'Get in touch with ZorryFash. Find our store address, phone number, email support details, and quick WhatsApp chat link.',
}
  ...
  return (
    <div>
      ...
      <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-28'>
        <img className='w-full md:max-w-[480px]' src={assets.contact_img.src || assets.contact_img} alt="Contact ZorryFash" />
