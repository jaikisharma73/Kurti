...
export const metadata = {
  title: 'Shipping Policy | ZorryFash',
  description: 'Learn about domestic and international shipping rates, processing times, delivery guidelines, and order tracking on ZorryFash.',
}
