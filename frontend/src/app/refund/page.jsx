...
export const metadata = {
  title: 'Refund Policy | ZorryFash',
  description: 'Understand ZorryFash refund eligibility, processing timelines, and exceptions for non-refundable purchase items.',
}
